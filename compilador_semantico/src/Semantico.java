...
public class Semantico {
  ...
  static StringBuffer       codigoJavascript = new StringBuffer();
...
//				bfw.write( regrasReconhecidas.toString() );
				bfw.write( codigoJavascript.toString() );
				bfw.close();
    ...
    static void regraSemantica( int numeroRegra ) throws ErroSemanticoException {
        ...
        switch ( numeroRegra ) {
            case  0: 	// START
            			codigoJavascript.append( "const main = () => {\n" );
            			nivelIdentacao++;
			    		break;
            case  1: 	// END
            			codigoJavascript.append( tabulacao( nivelIdentacao ) );
                		codigoJavascript.append( "\n}\n\n" );
                		codigoJavascript.append( "main()\n" );
                		break;
            case  2:	// VAR
            ...
            case  3:	// METHOD_ASSIGN
						...
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( nodo_1.getCodigoMinusculo() + " = " + nodo_2.getCodigoMinusculo() + "\n" );
						break;
            case  4:	// VARIAVEL
            ...
            case 15:    // WHILE
            			nodo_1 = pilhaSemantica.pop();
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( "while(" + nodo_1.getCodigoMinusculo() + ") {\n" );
						nivelIdentacao++;
						break;
            ...
            case 17:    // WHEN
            			nodo_1 = pilhaSemantica.pop();
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( "if(" + nodo_1.getCodigoMinusculo() + ") {\n" );
						nivelIdentacao++;
						break;
            case 18:    // WHEN_NOT
						codigoJavascript.append( " else {\n" );
						nivelIdentacao++;
						break;
            case 19:    // COND_MAIOR
            			nodo_2 = pilhaSemantica.pop();
            ...
            case 25:    // METHOD_LOG
            			nodo_1 = pilhaSemantica.pop();
    					codigoJavascript.append( tabulacao( nivelIdentacao ) );
    					codigoJavascript.append( "console.log(" + nodo_1.getCodigoMinusculo() + ")\n" );
    					break;
            case 30:    // FOR 
            			nodo_2 = pilhaSemantica.pop();
                        nodo_1 = pilhaSemantica.pop();
						...
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( "for(" + nodo_0.getCodigoMinusculo() + " = " + nodo_1.getCodigoMinusculo() + "; " + nodo_0.getCodigoMinusculo() + " <= " + nodo_2.getCodigoMinusculo() + "; " + nodo_0.getCodigoMinusculo() + "++) {\n" );
						nivelIdentacao++;
			            break;						
            case 31:    // METHOD_CASE
            			nodo_1 = pilhaSemantica.pop();
            			codigoJavascript.append( tabulacao( nivelIdentacao ) );
            			codigoJavascript.append( "switch(" + nodo_1.getCodigoMinusculo() + ") {\n");
						nivelIdentacao++;
						nivelIdentacao++;
						break;
            case 32:    // CASE_WHEN
            			...
            			nivelIdentacao--;
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( "case(" + nodo_1.getCodigoMinusculo() + "):\n" );
						nivelIdentacao++;
						break;   
            case 33:    // CASE BREAK
			            codigoJavascript.append( tabulacao( nivelIdentacao ) );
			            codigoJavascript.append("break\n");
                        break;	
            case 34:    // CASE DEFAULT BREAK
            			nivelIdentacao--;
		            	codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( "default:\n" );
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
						codigoJavascript.append( "break \n" );
						nivelIdentacao--;
						codigoJavascript.append( tabulacao( nivelIdentacao ) );
